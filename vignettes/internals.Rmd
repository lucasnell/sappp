...
vignette: >
  %\VignetteIndexEntry{sap internals}
...
This vignette outlines the internal data present in `sap`. 
These data inform the default parameters (see `vignette("parameters", "sap")`).
...
Saving the created objects as internal data for `sap`.
